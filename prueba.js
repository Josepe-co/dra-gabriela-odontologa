...
function _saveGasto(g)           { /* PRUEBA: solo RAM, sin Firebase */ }
function _updateGasto(id, f)     { /* PRUEBA: solo RAM, sin Firebase */ }
function _deleteGasto(id)        { /* PRUEBA: solo RAM, sin Firebase */ }
